...
var _b = require("@aws-sdk/client-s3"), S3Client = _b.S3Client, PutObjectCommand = _b.PutObjectCommand;
var fs = require("fs");
...
function detectObjectsAndLog(imageFilePath) {
    return __awaiter(this, void 0, void 0, function () {
        var imageBuffer, params, command, response, err_1;
        return __generator(this, function (_a) {
            switch (_a.label) {
                ...
                case 3:
                    err_1 = _a.sent();
                    console.error('Error detecting objects:', err_1);
                    return [3 /*break*/, 4];
...
// Usage
var imageFilePath = __dirname + '/mmm.jpg'; // Replace with the actual image file path
